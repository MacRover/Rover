...
if("TRUE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/indika/ROS_WS/src/see3cam)
  set(uvc_camera_DEVEL_PREFIX /home/indika/ROS_WS/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/indika/ROS_WS/install)
...
if(NOT "/home/indika/ROS_WS/src/see3cam/include " STREQUAL " ")
  set(uvc_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/indika/ROS_WS/src/see3cam/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/see3cam " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/see3cam' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'David Gossow <dgossow@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/indika/ROS_WS/src/see3cam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/indika/ROS_WS/devel/lib;/home/indika/ROS_WS/devel/lib;/home/indika/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
